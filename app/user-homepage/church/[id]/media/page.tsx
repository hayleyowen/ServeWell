...
export default function MediaPage({ params }: PageParams) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-400 to-blue-600 p-4 sm:p-6 md:p-8 flex items-center justify-center">
      <div className="max-w-6xl w-full py-8 sm:py-10 md:py-12">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
          <h1 className="text-2xl sm:text-3xl font-bold text-white">Media Archive</h1>
          <Link 
        ...
        {/* Filter Buttons */}
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 mb-6 w-full max-w-3xl">
        ...
        {isLoading ? (
          ...
          // Empty state that exactly mirrors the media grid layout
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div className="block bg-white rounded-lg shadow-lg p-6">
              <div className="relative pt-[56.25%] mb-4 bg-gray-100"></div>
