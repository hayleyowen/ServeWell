...
export default function MinistryHomepage({ params:{ ministryId } }: { params: { ministryId: string } }) {
  return (
    <section className="t-20 h-screen flex flex-col">
      <div className="flex-1 flex flex-col bg-blue-500 p-20">
        <div className="flex flex-col items-center justify-center pt-8">
          <h2 className="text-2xl font-bold text-white mb-8">{ ministryId } Ministry Homepage</h2>
        </div>
